...
public class receiver_listView_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        openFilterCareGiver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(receiver_listView_Activity.this, activity_filterGiver.class);
    ...
    private List<receiver_profile> createDummyProfiles() {
        ...
        profilesrec.add(new receiver_profile("Name: Elvira Serrano", "Black Mountain","Time: 8 am to 3 pm","Medicine Management"));
